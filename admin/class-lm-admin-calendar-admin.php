...
class Lm_Admin_Calendar_Admin {
	...
	public function create_dashboard_calendar() {
		...
		wp_add_dashboard_widget(
			'my_admin_calendar_widget',
			'My Admin Calendar',
			array( $this, 'my_admin_calendar_widget_function' )
		);
	}
	...
	public static function new_cpt_event() {
		...
		$opts['labels']['add_new']            = esc_html__( 'Add New Event', 'lm-admin-calendar' );
		$opts['labels']['add_new_item']       = esc_html__( 'Add New Event', 'lm-admin-calendar' );
		$opts['labels']['all_items']          = esc_html__( 'Events', 'lm-admin-calendar' );
		$opts['labels']['edit_item']          = esc_html__( 'Edit Event', 'lm-admin-calendar' );
		$opts['labels']['menu_name']          = esc_html__( 'Events', 'lm-admin-calendar' );
		$opts['labels']['name']               = esc_html__( 'Events', 'lm-admin-calendar' );
		$opts['labels']['name_admin_bar']     = esc_html__( 'Event', 'lm-admin-calendar' );
		$opts['labels']['new_item']           = esc_html__( 'New Event', 'lm-admin-calendar' );
		$opts['labels']['not_found']          = esc_html__( 'No Events Found', 'lm-admin-calendar' );
		$opts['labels']['not_found_in_trash'] = esc_html__( 'No Events Found in Trash', 'lm-admin-calendar' );
		$opts['labels']['search_items']       = esc_html__( 'Search Events', 'lm-admin-calendar' );
		$opts['labels']['singular_name']      = esc_html__( 'Event', 'lm-admin-calendar' );
		$opts['labels']['view_item']          = esc_html__( 'View Event', 'lm-admin-calendar' );
	...
	public static function new_taxonomy_category() {
		...
		$opts['labels']['add_new_item']                 = esc_html__( 'Add New Category', 'lm-admin-calendar' );
		$opts['labels']['add_or_remove_items']          = esc_html__( 'Add or remove Categories', 'lm-admin-calendar' );
		$opts['labels']['all_items']                    = esc_html__( 'Categories', 'lm-admin-calendar' );
		$opts['labels']['choose_from_most_used']        = esc_html__( 'Choose from most used Categories', 'lm-admin-calendar' );
		$opts['labels']['edit_item']                    = esc_html__( 'Edit Category', 'lm-admin-calendar' );
		$opts['labels']['menu_name']                    = esc_html__( 'Categories', 'lm-admin-calendar' );
		$opts['labels']['name']                         = esc_html__( 'Categories', 'lm-admin-calendar' );
		$opts['labels']['new_item_name']                = esc_html__( 'New Category Name', 'lm-admin-calendar' );
		$opts['labels']['not_found']                    = esc_html__( 'No Categories Found', 'lm-admin-calendar' );
		$opts['labels']['parent_item']                  = esc_html__( 'Parent Category', 'lm-admin-calendar' );
		$opts['labels']['parent_item_colon']            = esc_html__( 'Parent Category:', 'lm-admin-calendar' );
		$opts['labels']['popular_items']                = esc_html__( 'Popular Categories', 'lm-admin-calendar' );
		$opts['labels']['search_items']                 = esc_html__( 'Search Categories', 'lm-admin-calendar' );
		$opts['labels']['separate_items_with_commas']   = esc_html__( 'Separate Categories with commas', 'lm-admin-calendar' );
		$opts['labels']['singular_name']                = esc_html__( 'Category', 'lm-admin-calendar' );
		$opts['labels']['update_item']                  = esc_html__( 'Update Category', 'lm-admin-calendar' );
		$opts['labels']['view_item']                    = esc_html__( 'View Category', 'lm-admin-calendar' );
