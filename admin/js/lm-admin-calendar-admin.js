(function( $ ) {
	...
	$(function() {
		...
		// FOR THE AJAX CALL TO RETRIEVE SAVED EVENTS.
		var data = {
			action: 'load_events'
		};
			...
			$( '#lmac-calendar' ).fullCalendar({
				eventClick: function( calEvent, jsEvent, view ) {
					...
					if ( calEvent.categories ) {
						...
						$( '.lmac-modal-meta' ).html( '<span class="dashicons dashicons-calendar-alt"></span>' + calEvent.start._i + '<span class="dashicons dashicons-admin-post"></span> No categories' );
					}
		...
		// FOR THE DATA MANIPULATION OF THE DATEPICKER.
		$( '.MyDate' ).datepicker({
			dateFormat : 'yy-mm-dd'
		});
